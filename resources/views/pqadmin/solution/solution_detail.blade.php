    ...
    <div class="contents">
        <div class="grid_wrapper">
            <div class="g_6 contents_header">
                <h3 class="i_16_forms tab_label">查看方案</h3>
                <div><span class="label">查看方案信息</span></div>
            </div>
            ...
            <div class="g_12">
                <div class="widget_header">
                    <h4 class="widget_header_title wwIcon i_16_forms">查看方案信息</h4>
                </div>
                <div class="widget_contents noPadding">
                    ...
                    <div class="line_grid">
                        <div class="g_3"><span class="label">方案标题</span></div>
                        <div class="g_9">
                    ...
                    <div class="line_grid">
                        <div class="g_3"><span class="label">方案描述</span></div>
                        <div class="g_9">
