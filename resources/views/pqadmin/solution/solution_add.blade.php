    ...
    <div class="contents">
        <div class="grid_wrapper">
            ...
            <div class="g_6 contents_header">
                <h3 class="i_16_forms tab_label">新增解决方案</h3>
                <div><span class="label">解决方案信息</span></div>
            </div>
            ...
            <form action="{{url('pqadmin/solution_add')}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="g_12">
                    <div class="widget_header">
                        <h4 class="widget_header_title wwIcon i_16_forms">添加解决方案信息</h4>
                    </div>
                    <div class="widget_contents noPadding">
                        <div class="line_grid">
                            <div class="g_3"><span class="label">方案封面<span class="must">*</span></span>
                            </div>
                            <div class="g_9">
                        ...
                        <div class="line_grid">
                            <div class="g_3"><span class="label">方案标题<span class="must">*</span></span></div>
                            <div class="g_9">
                        ...
                        <div class="line_grid">
                            <div class="g_3"><span class="label">方案描述<span class="must">*</span></span></div>
                            <div class="g_9">
                        ...
                        <div class="g_12">
                            <div class="widget_header">
                                <h4 class="widget_header_title wwIcon i_16_wysiwyg">方案内容<span class="must">*</span></h4>
                            </div>
                            <div class="widget_contents noPadding">
                                <div class="line_grid">
                                    <div class="g_12">
