    ...
    <div class="contents">
        <div class="grid_wrapper">
            ...
            <div class="g_6 contents_header">
                <h3 class="i_16_forms tab_label">修改banner</h3>
                <div><span class="label">修改banner信息</span></div>
            </div>
            ...
            <form action="{{url('pqadmin/banner_edit',[$list->id])}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="g_12">
                    <div class="widget_header">
                        <h4 class="widget_header_title wwIcon i_16_forms">修改banner信息</h4>
                    </div>
