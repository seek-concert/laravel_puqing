    ...
    <div class="contents">
        <div class="grid_wrapper">
            <div class="g_6 contents_header">
                <h3 class="i_16_table tab_label">案例管理</h3>
                <div><span class="label">查看所有案例</span></div>
            </div>
            ...
            <div class="g_12">
                <div class="widget_header wwOptions">
                    <h4 class="widget_header_title wwIcon i_16_data">案例查看</h4>
                    <div class="w_Options i_16_settings">
                        <!-- Drop Menu -->
                        <ul class="drop_menu menu_with_icons right_direction">
                            <li>
                                <a class="i_16_add" href="{{url('pqadmin/case_add')}}" title="New Flie">
                                    <span class="label">新增案例</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        @foreach ($list as $value)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="simple_buttons" id="customer_del" onclick="customer_del({{$value->id}})" original-title="删除该案例,请谨慎操作">
                                        <div>删除</div>
                                    </div>
                                </td>
                            </tr>
