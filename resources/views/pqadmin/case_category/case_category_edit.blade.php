...
@section('content')
    ...
    <div class="contents">
        <div class="grid_wrapper">
            ...
            <form action="{{url('pqadmin/case_category_edit',[$list->id])}}" method="post">
                {{ csrf_field() }}
                <div class="g_12">
                    <div class="widget_header">
                        <h4 class="widget_header_title wwIcon i_16_forms">修改分类信息</h4>
                    </div>
                    <div class="widget_contents noPadding">
                        <div class="line_grid">
                            <div class="g_3"><span class="label">分类名称</span></div>
                            <div class="g_9">
                                <input class="simple_field" type="text" value="{{$list->name}}" name="name" required/>
                            </div>
                        </div>
                    </div>
                </div>
