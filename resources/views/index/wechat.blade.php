...
<div class="pro_item">
  <div class="pro_option">
    ...
    <div class="ser04_m" style="background:url(/index/images/wx3.jpg) no-repeat center center;height:530px;">
      <p style="font-size:32px;color:#fff;text-align:center;padding-top:100px;">为什么需要建微信网站?</p>
      <p style="font-size:12px;color:#fff;line-height:26px;text-align:center;padding-top:40px;">中国手机网民规模已突破9亿，微信毫无疑问已是用户青睐的移动社交平台NO.1<br />
        四分之一微信用户每天打开微信的平均次数超过30次<br />
        74%微信用户重点关注企业和媒体公众号</p>
      <p style="font-size:12px;color:#fff;line-height:26px;text-align:center;padding-top:25px;">基于庞大且活跃的用户群体，微信已建立了强大的影响力和生态粘合力<br />
        它不仅仅是聊天工具的载体，更是各企业家进行推广营销的利器<br />
        现在，如果哪位企业家还没弄明白什么是微信，为什么需要建微信网站，如何玩转微信营销？<br />
        那么很遗憾，您和您的企业品牌注定要被这个竞争激烈的微信营销时代淘汰出局</p>
    </div>
